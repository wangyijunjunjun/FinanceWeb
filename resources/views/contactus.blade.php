...
<head>
    ...
    <title>联系我们 - 中国支付通集团控股有限公司 </title>
    ...
    <style>
        ...
        .contact-content .list #mapSH span {
            display: block;
            padding-top: 210px;
            padding-bottom: 320px;
            background: url('{{$Contact_us->background_img}}') no-repeat center center;
        }
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-lg-3 col-sm-3 col-xs-3">
                <div class="logo"><a href="/home" class="block-show"></a></div>
...
<!--主体内容-->
<section class="summary summary-contact flex-container"><h1>联系我们</h1></section>
<div class="main contact-content" id="mainContent">
    <div class="items">
        <div class="container">
            <div class="list">
                <div id="mapSH">
     <span>{{$Contact_us->address_text}}<br/>
         {{$Contact_us->telephone}}</span>
                    <a href=""
                       target="_blank">查看完整地图</a>
                </div>
            </div>
        </div>
    </div>
