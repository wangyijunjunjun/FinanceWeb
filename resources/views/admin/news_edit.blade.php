    ...
    <form action="" method="post" class="form form-horizontal" id="form-news-edit">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-8">
                <input type="text" class="input-text" value="{{$News_item->title}}"
                       placeholder="{{$News_item->title}}"
        ...
        <div class="row cl">
            ...
            <input type="hidden" name="content" id="hidden_desc" value="{{$News_item->desc}}">
            <div class="col-4"></div>
        </div>
        <div class="row cl">
            ...
            <input type="hidden" name="content" id="hidden_content" value="{{$News_item->content}}">
            <input type="hidden" name="content" id="hidden_id" value="{{$News_item->id}}">
            <div class="col-4"></div>
        </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-8">
                @if($News_item->img != null)
                    <img id="img" src="{{$News_item->img}}"
        ...
        $("#form-news-edit").Validform({
            ...
            callback: function (form) {
                $('#form-news-edit').ajaxSubmit({
                    ...
                    url: '/admin/service/news/edit', // 需要提交的 url
                    dataType: 'json',
                    data: {
                        id: hidden_id,
